...
from physical_harness.core.actions import Basis, Check, Gripper, Pose, Primitive, encode, plain
from physical_harness.execution.actions import ActionExecutor, Driver, StepReceipt, StepReview
from physical_harness.execution.metrics import summarize
from physical_harness.perception.geometry import Intrinsics, deproject_masked_depth, fit_surface
...
class Fixture:
    ...
    def review_program(self, program, basis, deadline):
        from physical_harness.core.actions import Review
