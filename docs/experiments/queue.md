...
| 13 | Active: the first blue-attribute replication failed semantically (`0/1` for M0/M1/M2) while all three packet-bound physical executions passed; do not rerun or tune this cohort |
