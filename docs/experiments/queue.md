...
| 14 | Ready for one bounded selective-model gate: validate Astra on a negative M2 packet before considering Sol-to-Astra escalation; broader end-to-end efficiency remains untested |
