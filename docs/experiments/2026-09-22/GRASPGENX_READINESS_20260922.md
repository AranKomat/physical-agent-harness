...
| --- | --- |
| E1 | `H/physical_harness/integrations/graspgenx.py`; `types.py` (`Gripper`); `geometry.py` (`compose_tcp`); `worker.py` |
| E2 | `H/configs/planners/graspgenx-worker.template.json` |
