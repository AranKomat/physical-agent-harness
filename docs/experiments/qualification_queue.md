...
[validation report](../reference/SITUATED_EXECUTION_V2_INTEGRATION.md) and
[two-lane sequence](../reference/SITUATED_EXECUTION_V2.md#13-updated-experiment-sequence--two-lanes-one-motion-authority).
...
The [fresh dense async run](2026-09-22/DENSE_ASYNC_LOCALIZATION_20260922.md) now passes
...
or clearance admission. The subsequent [live pose shadow](2026-09-22/LIVE_POSE_SHADOW_20260922.md)
...
The [live surface consumer](2026-09-22/LIVE_SURFACE_FUSION_20260922.md) subsequently delivered
...
The [scale and label-blind check](2026-09-22/RADIO_SCALE_BLIND_RECOGNITION_20260922.md)
...
The [upstream SAM usage audit](2026-09-22/SAM31_UPSTREAM_AUDIT_20260922.md) now reproduces
...
The [causal acquisition-then-tracking replay](2026-09-22/SAM31_ACQUIRE_TRACK_20260922.md)
...
The [raw-score audit](2026-09-22/SAM31_RAW_SCORE_AUDIT_20260922.md) further finds radio-shaped
...
The [fixed-category controls](2026-09-22/SAM31_CATEGORY_CONTROLS_20260922.md) now pass on
...
The [offline candidate-surface replay](2026-09-22/SAM31_CANDIDATE_SURFACE_REPLAY_20260922.md)
...
[117-case prompt audit](2026-09-22/SAM31_ATTRIBUTE_ROBUSTNESS_20260922.md): `red radio` and
...
The [six-case full-description check](2026-09-22/CANDIDATE_DESCRIPTION_CHECK_20260922.md)
...
The subsequent [131-frame replay](2026-09-22/SITUATED_LONG_TRACKING_20260922.md) passed
...
The [Situated reset diagnostic](2026-09-22/SITUATED_TRACKING_RESET_20260922.md) is complete:
...
[SAM 3.1 full-stack no-motion capacity](2026-09-22/SAM31_CAPACITY_AND_TIMING_20260922.md)
...
The [incremental qualification report](2026-09-22/SAM31_INCREMENTAL_SHADOW_20260922.md)
...
1. Check radio depth/geometry. The [retained-depth audit](2026-09-22/RADIO_DEPTH_AUDIT_20260922.md)
   ...
   The subsequent [local SAM 2.1 Large comparison](2026-09-22/SAM21_LOCAL_COMPARISON_20260922.md)
   ...
   [live stationary co-residency](2026-09-22/SAM_LIVE_SHADOW_20260922.md) now passes:
   ...
   [policy-only moving shadow run](2026-09-22/SAM_MOVING_SHADOW_20260922.md) completed 768
   ...
   the separate SAM path. See [current perception options](2026-09-22/PERCEPTION_OPTIONS_20260922.md).
   The earlier timing results predate removal; no post-removal speedup is claimed.
   The [depth-aware patch replay](2026-09-22/DEPTH_SURFACE_PATCHES_20260922.md) then separated
...
The [native hold-codec and stationary-settling diagnostics](2026-09-21/HYBRID_NATIVE_QUALIFICATION_20260921.md)
...
[native exploratory pulses](2026-09-21/HYBRID_NATIVE_EXPLORATION_20260921.md) passed forward
...
A [retained-view depth coverage diagnostic](2026-09-21/HYBRID_DEPTH_COVERAGE_20260921.md)
identified substantial blind regions around proposed 5 cm translations. A
[fresh calibrated hold and authored-mesh audit](2026-09-21/HYBRID_CALIBRATED_GEOMETRY_20260921.md)
...
The [empty-scene response experiment](2026-09-21/HYBRID_EMPTY_BASE_DIAGNOSTIC_20260921.md)
...
The [motion-measurement diagnosis](2026-09-21/HYBRID_MOTION_MEASUREMENT_DIAGNOSIS_20260921.md)
...
The [tiny-perturbation A-short/B-short diagnostic](2026-09-21/HYBRID_TINY_HANDOFF_20260921.md)
...
Two [fresh calibrated approaches](2026-09-21/HYBRID_TARGET_ACQUISITION_20260921.md) now
...
The [acquisition cadence and coverage audits](2026-09-22/SINGLE_GPU_DENSE_OBSERVATIONS_20260922.md)
...
The [single-GPU restore and co-residency test](2026-09-22/SINGLE_GPU_REPLAY_20260922.md)
...
The subsequent [grounding capacity probe](2026-09-22/SINGLE_GPU_GROUNDING_20260922.md)
...
The [normal single-GPU RPC integration](2026-09-22/SINGLE_GPU_ONLINE_20260922.md) subsequently
...
The [compiler replay](2026-09-22/ACTION_COMPILER_REPLAY_20260922.md) processed 78 legal
RGB-D views and produced zero qualified contact actions. The
[GraspGenX readiness audit](2026-09-22/GRASPGENX_READINESS_20260922.md) identifies actual
R1Pro gripper/TCP and closure-geometry gaps; inference is not enabled.
The [online grounding report](2026-09-22/ONLINE_TARGET_GROUNDING_20260922.md) records the
fresh shadow experiment, not navigation authority. The
[post-policy stop diagnosis](2026-09-22/POST_POLICY_STOP_ANALYSIS_20260922.md) preserves
...
The [joint position-window shadow](2026-09-22/JOINT_STOP_SHADOW_20260922.md) now separates
...
[extended-view coverage audit](2026-09-22/EXTENDED_VIEW_CLEARANCE_20260922.md) still finds
all sampled geometry below 40 cm outside the three cameras. The user separately
authorized [one labeled 10 cm exploratory transit](2026-09-22/EXPLORATORY_TRANSIT_20260922.md)
...
The subsequent [matched target-directed handoff](2026-09-22/MATCHED_TARGET_HANDOFF_20260922.md)
...
A [CPU-only acquisition audit](2026-09-22/ACQUISITION_REPRODUCIBILITY_20260922.md) now locates
...
That [single-GPU replay](2026-09-22/SINGLE_GPU_REPLAY_20260922.md) has now completed: repeated
