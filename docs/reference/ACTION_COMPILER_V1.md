...
python -m physical_harness.planning.actions demo --output runs/compiler-fixture-new
python -m pytest -q
ruff check .
```
...
python tools/validate.py \
  --output runs/compiler-validation-new
```
