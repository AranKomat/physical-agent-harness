...
[the current progress report](../experiments/2026-09-21/EXPERIMENT_PROGRESS_20260921.md). This integration
...
Subsequent native work: the [hold-codec and stationary-settling diagnostics](../experiments/2026-09-21/HYBRID_NATIVE_QUALIFICATION_20260921.md)
...
```python
from physical_harness.execution.handoff import HybridExecutor, journal_sink, wrap_native
...
python -m physical_harness.execution.handoff demo --output runs/hybrid-v0-fixture-001
