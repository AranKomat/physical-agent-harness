...
`physical_harness.situated` adds journal-backed identity/semantic history,
...
The [corrected live SAM 3.1 report](SAM31_INCREMENTAL_SHADOW_20260922.md)
...
python -m physical_harness.situated demo --output <fresh-private-run-directory>
