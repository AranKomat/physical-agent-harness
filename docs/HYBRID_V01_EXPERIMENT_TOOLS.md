...
[experiment sequence](HYBRID_EXPERIMENT_SEQUENCE.md) is the current empirical queue.

## 1. Legal target point -> staging pose

`physical_harness.hybrid_v0.staging` adds a small geometric staging resolver.
