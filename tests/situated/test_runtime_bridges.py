...
from physical_harness.contracts import EventType
from physical_harness.events import EventBus
from physical_harness.situated.identity import IdentityLedger
from physical_harness.situated.integration import publish_monitor_event
from physical_harness.situated.monitor import MonitorSignal
from physical_harness.state import WorldState

from .test_identity import claim, track
...
def test_clean_import_does_not_load_inference_or_simulation():
    subprocess.run(
        [sys.executable, '-c',
         'import sys; import physical_harness.situated; '
