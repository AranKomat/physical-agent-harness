...
from physical_harness.world.memory import Asset, Card, MemoryStore, Retriever
from physical_harness.world.memory.media import make_crop


def test_existing_harness_evidence_store_contract(tmp_path):
    EvidenceStore = pytest.importorskip('physical_harness.core.evidence').EvidenceStore
