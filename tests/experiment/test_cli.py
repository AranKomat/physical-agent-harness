...
from physical_harness.experiment.__main__ import read_config

CONFIG = Path(__file__).parents[2] / 'configs/experiment_v010/doctor.fixture.json'


def test_doctor_does_not_start_native_or_network():
    result = subprocess.run([sys.executable, '-m', 'physical_harness.experiment', 'doctor',
