...
from physical_harness.perception.track_bindings import PerceptionNeed, schedule_perception
from physical_harness.reasoning.routing import Branch, branch_packet, resolve_branch
...
def test_branch_boolean_is_not_interchangeable_with_numeric_zero():
    from physical_harness.core.tasks import Fact, FactPacket
    from physical_harness.reasoning.routing import Branch, branch_packet
