...
from physical_harness.execution.action_bridge import CatalogMotor
from physical_harness.integrations.grasp_client import GraspWorkerClient
from physical_harness.perception.geometry import Intrinsics
from physical_harness.perception.overlays import annotate_candidates
from physical_harness.planning.actions.cartesian import (
    CartesianExecutor,
    CartesianPort,
    bounded_pose_step,
    pose_error,
...
def test_dispatcher_tracks_classical_interventions_but_not_passive_reads():
    from physical_harness.execution.action_bridge import PrimitiveDispatcher
    from physical_harness.reasoning.action_proposals import inspect_candidate
    f = Fixture()
    notifications = []
    class Port:
