...
from physical_harness.action_compiler.serde import (
    cloud_from_dict,
    gripper_from_dict,
    proposal_from_dict,
)
from physical_harness.action_compiler.types import Pose, number, plain, strict_loads
...
def test_json_size_limit_counts_utf8_bytes():
    from physical_harness.action_compiler.types import strict_loads
