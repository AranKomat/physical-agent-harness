...
from physical_harness.integrations.experiment.native_rpc import ProcessNative
from physical_harness.integrations.experiment.transport import HttpTransport, TransportFailure
...
def test_actual_native_subprocess_roundtrip():
    command = [sys.executable, '-m', 'physical_harness.integrations.experiment', 'serve-native',
               '--factory', 'physical_harness.integrations.experiment.fixture:rpc_fixture_factory',
               '--episode', 'ep']
