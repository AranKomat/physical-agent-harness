"""Evidence-bound visual verifier. Uncalibrated models cannot complete tasks."""
...
class EvidenceVisualVerifier:
    ...
    def __init__(self, judge, *, before, after, qualified=False):
    ...
    def packet(self, request):
        ...
        return {
            ...
            "Return only JSON with verdict, confidence (0 to 1), evidence_ids (list), reason, tier (2).",
    ...
    def verify(self, request):
        ...
        return VerificationResult(
            ...
            {"raw_verdict": raw, "qualified": self.qualified, "citations_supported": supported},
        )
