...
from physical_harness.core.contracts import VerificationResult, VerificationVerdict
from physical_harness.integrations.experiment.memory_routing import INFORMATION_NEED_SCHEMA
from physical_harness.integrations.experiment.validation import identifiers, text
from physical_harness.reasoning.visual_verifier import EvidenceVisualVerifier
from physical_harness.world.memory.schemas import Cutoff, Draft
...
def parse_goal(value: dict[str, Any]) -> Goal:
    from physical_harness.integrations.experiment.validation import fields
